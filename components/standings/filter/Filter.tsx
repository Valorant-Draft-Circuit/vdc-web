      ...
      <div className="flex gap-8 xl:hidden">
        <Popover>
          ...
          <PopoverPanel
            transition
            anchor="bottom"
            className="rounded-xl ml-5 bg-gray-200 dark:bg-vdcGrey drop-shadow-mg transition duration-200 ease-in-out [--anchor-gap:--spacing(5)] data-closed:-translate-y-1 data-closed:opacity-0"
          >
            <div className="p-3">
              <Field>
