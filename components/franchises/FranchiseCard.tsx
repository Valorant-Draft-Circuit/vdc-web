...
export default function FranchiseCard({ franchise }: { franchise }) {
  ...
  return (
    <div
      ...
      className="flex flex-row py-4 px-5 rounded-2xl h-28 xl:m-auto xl:h-32 xl:w-68 xl:justify-center items-center drop-shadow-xl bg-gradient-to-tl from-[var(--p)] to-[var(--s)] hover:via-[#ffffff] hover:from-[var(--s)] hover:to-[var(--p)] transition-colors duration-900 ease-in-out"
    >
