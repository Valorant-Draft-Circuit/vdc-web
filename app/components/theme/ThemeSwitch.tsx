...
export default function ThemeSwitch() {
  ...
  return (
    <Switch
      checked={dark}
      onChange={setDark}
      className="group relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 transition-colors duration-200 ease-in-out focus:ring-0 focus:ring-vdcWhite focus:ring-offset-2 focus:outline-hidden data-checked:bg-vdcBlack data-checked:border-vdcWhite"
    >
